...
func (r *Request) SetJar(v http.CookieJar) {
	r.jar = v
}

func (r *Request) SetCheckRedirect(v func(req *http.Request, via []*http.Request) error) {
	r.checkRedirect = v
}

func (r *Request) SetTLSClient(v *tls.Config) {
	r.tlsClientConfig = v
}

func (r *Request) SetProxy(v func(*http.Request) (*url.URL, error)) {
	r.proxy = v
}

func (r *Request) SetTransport(v *http.Transport) {
	r.transport = v
}

// Debug model
func (r *Request) SetDebug(v bool) {
	r.debug = v
}
